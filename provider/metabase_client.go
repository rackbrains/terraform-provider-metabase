...
type MetabaseClientInterface interface {
	updateCard(id string, query putCardQuery) (*CardResponse, error)
	postCard(query postCardQuery) (*CardResponse, error)
	getCard(id string) (*CardResponse, error)
	deleteCard(id string) error
	getCollection(id string) (*CollectionResponse, error)
	updateCollection(id string, query PutCollectionQuery) (*CollectionResponse, error)
	createCollection(query PostCollectionQuery) (*CollectionResponse, error)
}
...
func (c MetabaseClient) updateCard(id string, query putCardQuery) (*CardResponse, error) {
	queryJson, err := json.Marshal(query)
	if err != nil {
...
func (c MetabaseClient) postCard(query postCardQuery) (*CardResponse, error) {
	queryJson, err := json.Marshal(query)
	if err != nil {
		print("json creation failed\n")
		return nil, err
...
type CollectionResponse struct {
	...
	// "slug":"nicolas_lagier_s_personal_collection",
	// "can_write":true,
	// "personal_owner_id":20,
	// "effective_ancestors":[
	// 	{"metabase.models.collection/is-root?":true,"name":"Our analytics","id":"root","can_write":true}
	// ],
	// "effective_location":"/",
	// "location":"/"
}
type PutCollectionQuery struct{}
...
func (c MetabaseClient) getCollection(id string) (*CollectionResponse, error) {
	url := c.host + "/api/collection/" + id
	print("Getting collection @ ", url, "\n")
	req, _ := http.NewRequest("GET", url, nil)
	req.Header.Add("Content-Type", `application/json`)
	req.Header.Add("X-Metabase-Session", c.id)
	resp, err := c.httpClient().Do(req)
...
func (c MetabaseClient) updateCollection(id string, query PutCollectionQuery) (*CollectionResponse, error) {
	return nil, nil
}

func (c MetabaseClient) createCollection(query PostCollectionQuery) (*CollectionResponse, error) {
	return nil, nil
}
